...
def report(instance, filename, report_tuples=None, report_sites_name={}) -> dict:
    ...
    Args:
        ...
        - report_sites_name: (optional) dict of names for created timeseries
          sheets
    Return:
        - dict with all relevant optimization data
    """
    ...
    # costs.to_csv("costes.csv", sep=";")
    # cpro.to_csv("cpro.csv", sep=";")
    # ctra.to_csv("ctra.csv", sep=";")
    # csto.to_csv("csto.csv", sep=";")
    ...
    # Return all the relevant results in order to control the BSS later
    return results